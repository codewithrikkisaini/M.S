...
<body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color: #334155; background-color: #f8fafc; padding: 20px; margin: 0;">
    <div style="max-width: 600px; margin: 20px auto; background: #ffffff; border-radius: 12px; border: 1px solid #e2e8f0; padding: 28px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.05);">
        ...
        <div style="border-bottom: 2px solid #10b981; padding-bottom: 16px; margin-bottom: 24px; text-align: center;">
            <h2 style="color: #059669; margin: 0; font-size: 24px; font-weight: 800;">🎉 Application Approved!</h2>
            <p style="color: #64748b; font-size: 14px; margin-top: 6px; margin-bottom: 0;">Your property <strong>{{ $hotel->name }}</strong> is now live on our platform.</p>
        </div>

        <p style="font-size: 15px; color: #1e293b; line-height: 1.6;">
            Dear <strong>{{ $adminUser->name ?? 'Hotel Administrator' }}</strong>,
        </p>

        <p style="font-size: 14px; color: #475569; line-height: 1.6;">
            Great news! Your hotel registration application for <strong>{{ $hotel->name }}</strong> has been officially reviewed and <strong style="color: #059669;">APPROVED</strong> by our Super Admin team.
        </p>

        <div style="background-color: #f0fdf4; border-radius: 10px; padding: 20px; margin: 24px 0; border: 1px solid #bbf7d0;">
            <h3 style="margin-top: 0; color: #166534; font-size: 16px; margin-bottom: 12px;">Account Details</h3>
            <table style="width: 100%; border-collapse: collapse; font-size: 14px;">
                ...
                <tr>
                    <td style="padding: 4px 0; color: #166534;"><strong>Account Status:</strong></td>
                    <td style="padding: 4px 0;"><span style="background: #dcfce7; color: #15803d; padding: 2px 10px; border-radius: 9999px; font-weight: bold; font-size: 12px;">ACTIVE</span></td>
                </tr>
            </table>
        </div>

        <p style="font-size: 14px; color: #475569; line-height: 1.6;">
            You can now log into your hotel administration dashboard to manage rooms, bookings, tariffs, guest check-ins, and invoices.
        </p>
