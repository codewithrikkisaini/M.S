<div>
    ...
    <div class="mb-6 flex items-center justify-between">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="text-2xl font-black text-gray-900 tracking-tight">Add Rooms & Room Type Management</h1>
                <p class="text-sm text-gray-500 mt-0.5">Add physical rooms to hotel inventory or configure room type tariffs (daily/weekly/monthly rates)</p>
            </div>
        </div>
    </div>
            ...
            <div>
                <div class="flex items-center justify-between mb-4 border-b border-slate-100 pb-3">
                    <div class="flex items-center gap-2">
                        ...
                        <h3 class="text-sm font-bold text-slate-800">1. Add / Preset Room Type Tariff</h3>
                    </div>
            ...
            <div>
                <div class="flex items-center justify-between mb-4 border-b border-slate-100 pb-3">
                    <div class="flex items-center gap-2">
                        ...
                        <h3 class="text-sm font-bold text-slate-800">2. Add Physical Room</h3>
                    </div>
