        ...
        <div class="w-full max-w-sm relative z-10">
            ...
            <form action="{{ route('login.post') }}" method="post" x-data="{ showPassword: false }" class="space-y-5" id="login-form">
                ...
                <div class="flex items-center gap-2.5">
                    ...
                    <label for="remember" class="text-sm text-slate-600 cursor-pointer select-none">Remember me</label>
                </div>

                {{-- Submit --}}
                <button type="submit"
                        class="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3.5 rounded-xl shadow-md transition-all cursor-pointer flex items-center justify-center gap-2">
