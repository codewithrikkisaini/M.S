...
class TrialActivatedMail extends Mailable
{
    ...
    public function content(): Content
    {
        ...
        $resetUrl = route('login'); // Secure login/reset route
            ...
            html: "
                <div style='font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e2e8f0; border-radius: 8px; overflow: hidden;'>
                    ...
                    <div style='padding: 24px; color: #334155;'>
                        ...
                        <p style='font-size: 13px; color: #64748b;'>Need to set or reset your password? You can request a reset anytime on the <a href='{$resetUrl}'>login page</a>.</p>
                    </div>
                </div>
            ",
        );
